...
def agruparPor(peliculas, opcion):
    ...
    for pelicula in peliculas:
        ...
        if opcion == "anio":
            ...
            if pelicula[opcion] not in resultados:
                resultados[pelicula[opcion]] = []
            
            resultados[pelicula[opcion]].append(pelicula)
...
print(agruparPor(peliculas, 'anio'))